...
import { checkHowManyUsersMintedNFT, getUserMintedNFT, isUserMintedNFT } from "@/lib/contract_utility/nftUtility";
...
export default function RewardProgram() {
    ...
    const inviteCodeLink = inviteCode
        ? `https://world.org/mini-app?app_id=${ENV_VARIABLES.WORLD_MINIAPP_ID}&path=${encodeURIComponent('/?invite=' + inviteCode)}`
        : '';
    ...
    const shareOptions = [
        {
            ...
            share: () => {
                window.open(`https://wa.me/?text=${encodeURIComponent(`Join me on FlickShare! ${inviteCodeLink}`)}`, '_blank');
            }
        },
        {
            name: "Telegram",
            ...
            share: () => {
                window.open(`https://t.me/share/url?url=${encodeURIComponent(inviteCodeLink)}&text=${encodeURIComponent('Join me on FlickShare!')}`, '_blank');
            }
        },
        {
            name: "Twitter",
            ...
            share: () => {
                window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Join me on FlickShare! ${inviteCodeLink}`)}`, '_blank');
            }
        },
        {
            name: "Email",
            ...
            share: () => {
                window.open(`mailto:?subject=Join me on FlickShare&body=Check out this awesome app: ${inviteCodeLink}`);
            }
        }
    ];
            ...
            <div className="max-w-sm mx-auto px-4">
                    ...
                    <div className="bg-white border-2 border-yellow-400 rounded-2xl p-6 shadow-lg mb-6 relative overflow-visible animate-pulse-glow">
                        ...
                        {!nftClaimed ? (
                            ...
                            <div className="text-center relative z-1">
                                ...
                                <h2 className="!text-lg !font-bold !text-black">NFT Already Claimed!</h2>
                                <p className="!text-gray-600 !text-sm !mt-1">Your exclusive Early User NFT is in your wallet</p>
                    ...
                    <div className="!bg-white !border-2 !border-yellow-400 !rounded-2xl !p-6 !shadow-lg !mb-6 !relative !overflow-visible !animate-pulse-glow">
                        ...
                        <div className="flex items-center mb-5 relative z-1">
                            ...
                            <div>
                                ...
                                <p className="text-yellow-700 text-sm font-medium">Limited edition - Only 1,000 available</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-yellow-50 p-3 rounded-lg mb-6 border border-yellow-200 relative">
                            ...
                            <div className="w-full bg-yellow-200 rounded-full h-2 overflow-hidden">
                                <div
                                    ...
                                    style={{ width: `${(BigInt(totalMintedUsers) / BigInt(1000)) * BigInt(100)}%` }}
                                ></div>
                            </div>
                            <p className="text-yellow-700 text-xs mt-3 font-medium">{(BigInt(1000) - BigInt(totalMintedUsers)).toString()} remaining!</p>
                        </div>
                ...
                <section className="pb-6">
                    ...
                    <div className="space-y-3">
                        {/* Review a movie */}
                        <button className="w-full bg-white border border-gray-200 rounded-2xl p-4 hover:bg-gray-50 active:bg-gray-100 transition-all duration-200 group">
                        ...
                        {/* Daily check in */}
                        <button
                            className="w-full bg-white border border-gray-200 rounded-2xl p-4 hover:bg-gray-50 active:bg-gray-100 transition-all duration-200 group disabled:opacity-50 disabled:cursor-not-allowed"
                            onClick={dailyCheckIn}
                            disabled={loading || isConfirming}
                        >
                            <div className="flex items-center">
                                <div className="w-12 h-12 bg-gray-50 group-hover:bg-gray-100 rounded-xl flex items-center justify-center mr-4">
                                    <CheckCircle className="w-5 h-5 text-gray-700" strokeWidth={2} />
                                </div>
                                <div className="flex-1 text-left">
                                    <h4 className="font-semibold text-black text-base mb-1">
                                        Daily Check-in
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="w-full bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-2xl p-5">
                            <div className="flex items-center mb-4">
                                ...
                                <div className="flex-1">
                                    <h4 className="font-bold text-black text-lg mb-1">Invite a friend</h4>
                            ...
                            {inviteCodeLink ? (
                                <>
                                    <div className="mb-4">
                                        <p className="text-xs text-gray-500 mb-2 font-medium">Your personal invite link:</p>
                                        <div className="flex items-center gap-2">
                                            <div className="flex-1 bg-white border border-gray-300 rounded-lg px-3 py-2 overflow-hidden">
                                                <p className="text-sm text-gray-700 truncate">{inviteCodeLink}</p>
                                            </div>
                                            <button
                                                onClick={handleCopyLink}
                                                className={`flex items-center justify-center w-12 h-11 rounded-lg ${copied ? "bg-green-500" : "bg-black"
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-500 mb-2 font-medium">Share via:</p>
                                ...
                                <div className="flex items-center justify-center py-4">
                                    <div className="animate-pulse flex items-center">
                                        ...
                                        <span className="text-sm text-gray-500">Generating your invite link...</span>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        >
                            <button
                                ...
                                className={`w-full bg-white border border-gray-200 rounded-2xl p-4 transition-all duration-200 group ${completedTasks["FOLLOW_DISCORD"] ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-50"
                                    }`}
                            >
                                <div className="flex items-center">
                                    <div className="w-12 h-12 bg-gray-50 group-hover:bg-gray-100 rounded-xl flex items-center justify-center mr-4">
                        ...
                        >
                            <button
                                ...
                                className={`w-full bg-white border border-gray-200 rounded-2xl p-4 transition-all duration-200 group ${completedTasks["FOLLOW_X"] ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-50"
                                    }`}
                            >
                                <div className="flex items-center">
                                    <div className="w-12 h-12 bg-gray-50 group-hover:bg-gray-100 rounded-xl flex items-center justify-center mr-4">
                        ...
                        >
                            <button
                                ...
                                className={`w-full bg-white border border-gray-200 rounded-2xl p-4 transition-all duration-200 group ${completedTasks["FOLLOW_INSTAGRAM"] ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-50"
                                    }`}
                            >
                                <div className="flex items-center">
                                    <div className="w-12 h-12 bg-gray-50 group-hover:bg-gray-100 rounded-xl flex items-center justify-center mr-4">
                        ...
                        >
                            <button
                                ...
                                className={`w-full bg-white border border-gray-200 rounded-2xl p-4 transition-all duration-200 group ${completedTasks["FOLLOW_FACEBOOK"] ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-50"
                                    }`}
                            >
                                <div className="flex items-center">
                                    <div className="w-12 h-12 bg-gray-50 group-hover:bg-gray-100 rounded-xl flex items-center justify-center mr-4">
